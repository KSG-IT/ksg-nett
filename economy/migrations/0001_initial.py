# Generated by Django 2.2 on 2019-06-01 18:07
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('card_uuid', models.CharField(blank=True, default=None, max_length=50, null=True, unique=True)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('modified', model_utils.fields.AutoLastModifiedField(default=django.utils.timezone.now, editable=False, verbose_name='modified')),
                ('signed_off_time', model_utils.fields.MonitorField(default=None, monitor='signed_off_by', null=True)),
                ('collection', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.SET_NULL, related_name='purchases', to='economy.PurchaseCollection')),
                ('signed_off_by', models.ForeignKey(null=True, on_delete=django.db.models.deletion.DO_NOTHING, related_name='verified_purchases', to=settings.AUTH_USER_MODEL)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('purchase', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='product_orders', to='economy.Purchase')),
            ],
        ),
        migrations.CreateModel(
            name='DepositComment',

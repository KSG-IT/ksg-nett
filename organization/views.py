...
def internal_group_detail(request, internal_group_id):
    if request.method == "GET":
        ...
        return render(
            request, template_name="organization/internal_groups.html", context=ctx
        )
    else:
...
def internal_group_edit(request, internal_group_id):
    if request.method == "GET":
        return render(
            request, template_name="organization/internal_group_edit.html", context={}
        )

    if request.method == "POST":
        return render(
            request, template_name="organization/internal_groups.html", context={}
        )
